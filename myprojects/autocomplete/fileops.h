...
static inline
bool valid_token_to_lower(const char *oldtoken, char *newtoken)
{
...
static inline
int read_whole_file_and_tokenize(FILE* fptr, const char *words[])
{
...
int read_data(const char* filepath, const char* words[])
{
    FILE *fptr;
